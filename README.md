...
- [cl-yag](https://git.sr.ht/~solene/cl-yag) (Common-Lisp) - Static site generator producing gemini, gopher and html.
...
- __gemini://gemini.thegonz.net/gmi2html.sed__ (Sed) - sed script to convert text/gemini to html.
